...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚒ ᴍʏ ᴏᴡɴᴇʀ', url='http://t.me/Sathan_of_telegram')
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('ᴍᴀɴɴᴜᴀʟ ꜰɪʟᴛᴇʀ 🔧r', callback_data='manuelfilter'),
        ...
        buttons = [[
            InlineKeyboardButton('BASTIN™', url='https://t.me/BASTINJOE'),
